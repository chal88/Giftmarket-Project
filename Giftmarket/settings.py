"""
Django settings for Giftmarket project with custom user model and
MySQL configuration.
"""
...
SECRET_KEY = 'your-secret-key'   # replace this later with env variable
DEBUG = True
...
# Email backend (for real sending)
