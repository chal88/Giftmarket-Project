    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personalized_text', models.CharField(blank=True, max_length=255, null=True)),
                ('personalized_image', models.ImageField(blank=True, null=True, upload_to='personalized_images/')),
                ('price', models.DecimalField(decimal_places=2, max_digits=10)),
        ...
        migrations.AddField(
            model_name='store',
            name='vendor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stores', to='shop.vendorprofile'),
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
